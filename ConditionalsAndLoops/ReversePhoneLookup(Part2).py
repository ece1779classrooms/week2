...
# This means that given a phone number, you get the name of the person who is registered with that phone number. For this problem, you have been asked to write a solution using a dictionary
